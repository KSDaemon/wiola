...
* Go to https://github.com/KSDaemon/wiola/pulls and open a new pull request with your changes.
...
* Go to the issue tracker and [filter open issues by the `support` label](https://github.com/KSDaemon/wiola/issues?q=is%3Aopen+is%3Aissue+label%3Asupport).
...
* Leave a message when closing saying "Cleaning up stale issue. Please reopen or ping us if and when you're ready to resume this. See https://github.com/KSDaemon/wiola/blob/latest/CONTRIBUTING.md#clean-up-issues-and-prs for more details."
